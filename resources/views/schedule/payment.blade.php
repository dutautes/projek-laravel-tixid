...
@section('content')
    <div class="card w-50 d-block mx-auto my-5 p-4">
        <div class="card-body">
            ...
            <img src="{{ asset('storage/' . $ticket['ticketPayment']['barcode']) }}" class="mx-auto d-block">
            ...
            <hr>
            @php
                // harga keseluruhan dari total price yang udah dapet diskon promo ditambah biaya layanan 4000 dikali jumlah tiket
